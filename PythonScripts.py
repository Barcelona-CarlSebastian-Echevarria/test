    ...
    while True:
        ...
        if lines.isdigit():
            ...
            if 1 <= lines <= MAX_LINES:
                ...
                print("The lines must be greater than zero")
        else:
            print("enter a number")
    ...
    while True:
        ...
        if amount.isdigit():
            ...
            if MIN_BET <= amount <= MAX_BET:
                ...
                print(f"The bet must be within {MIN_BET} - {MAX_BET}")
        else:
            print("enter a number")
...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print(f"You do not have such large amount. Your current balance is {balance}")
        else:
            break
